  ...
  return (
    <div
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center text-white px-4 sm:px-6 lg:px-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold mb-2 sm:mb-4 tracking-tight leading-tight max-w-4xl">
          Discover Vakratunda Homestay in Ujjain
        </h1>
        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-2xl mb-4 sm:mb-8 font-light italic">
