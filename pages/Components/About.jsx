...
const BannerSection = () => {
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="w-full min-h-screen bg-cover bg-center py-16 md:py-16 px-4 md:px-8">
      <div className="w-full max-w-7xl mx-auto">
        <motion.div variants={fadeIn} className="text-center mb-8">
          <h1 className="text-2xl xs:text-3xl sm:text-4xl font-bold text-black">
            VAKRATUNDA HOMESTAY
          </h1>
        </motion.div>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-6xl">
            ...
            <motion.p
              variants={fadeIn}
              className="hidden md:block text-justify text-base lg:text-lg leading-relaxed text-gray-800 px-4 lg:px-16">
              &quot;Experience the warmth of Indian hospitality at Vakratunda
